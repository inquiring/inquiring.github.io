module.exports = {
	block: 'page',
	title: 'Автономная газификация домов и предприятий',
	favicon: '/favicon.ico',
    lang: 'ru',
	head: [
        { elem: 'meta', attrs: {'cache-control': 'must_revalidate, public, max-age=3600'}},
        { elem: 'meta', attrs: { name: 'theme-color', content: '#317EFB'}},
        { elem: 'meta', attrs: { name: 'description', content: 'Автономная газификация домов и предприятий в Нижегородской, Владимирской и Ивановской областям' } },
        { elem: 'meta', attrs: { name: 'keywords', content: 'Автономная газификация в Заволжье' } },
        { elem: 'meta', attrs: { name: 'keywords', content: 'Автономная газификация в Балахне' } },
        { elem: 'meta', attrs: { name: 'keywords', content: 'Автономная газификация в Городце' } },
	...
	mix: {
		block: 'theme',
		mods: { color: 'whitepaper-default', space: 'default', size: 'default', gap: 'medium', menu: 'default', breakpoint: 'default', font: 'times' }
	},
	content: [
        {
        ...
        },
        {
            ...
            content: [
                ...
                {
                    elem: 'section',
                    mix: { block: 'decorator', mods: {'space-v': 'l',} },
                    content: [
                        {
                            elem: 'heading',
                                    ...
                                    content: [
                                        {
                                            ...
                                            content: {
                                                ...
                                                content: [
                                                    ...
                                                    ' – потребление газовых ресурсов становится доступным для вас в полном объеме. Ваша личная газопроводная система не зависит от давления в магистралях. Вам не страшны аварии общего газопровода. Кроме того, подобное оборудование существенно влияет на капитализацию вашего жилища;'
                                                ...
                                                content: [
                                                    {
                                                        ...
                                                        content: 'сгорание без запаха'
                                                    },
                                                    ' – современное газовое оборудование повсеместно располагается в квартирах многоэтажек. Процессы сгорания голубого топлива в устройствах протекают без выделения резких запахов, а вредные продукты выводятся наружу при помощи дымохода.'
                                                ]
                ...
                {
                    elem: 'section',
                    attrs: { style: 'background: var(--color-bg-normal)' },
                    mix: { block: 'decorator', mods: {'space-v': 'l',} },
                    content: [
                        {
                            elem: 'content',

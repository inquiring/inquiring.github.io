...
modules.define('new-menu', ['i-bem-dom', 'link', 'button', 'jquery'], function(provide, bemDom, Link, MenuButton, $) {
    ...
    onSetMod: {
        js: {
            inited: function() {
                ...
                // console.log(link);
                var button = this.findChildElems(MenuButton);
                // console.log(button);
                ...
                this._events(button).on('click', function() {
                    console.log('?')
                    let expanded = button.attr('aria-axpanded') === 'true' || false;
...
/* begin: ../../common.blocks/new-menu/__button/new-menu__button.js */
modules.define('new-menu__button', ['i-bem-dom'], function(provide, bemDom) {

provide(bemDom.declElem('new-menu', 'button', {
    onSetMod: {
        js: {
            inited: function() {
...
/* end: ../../common.blocks/new-menu/__button/new-menu__button.js */
